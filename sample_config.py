...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/SDMyTgOrgBot")
    ...
    # please reopen
    # https://github.com/Sadew451/MyTelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/SDBOTs_inifinity"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @SDBOTs_inifinity")
